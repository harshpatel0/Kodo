# Parallel Batching (single source of truth for the Parallel task category)

Output a JSON array `[...]` instead of one action, to run several actions in a single turn. Use it ONLY when:
